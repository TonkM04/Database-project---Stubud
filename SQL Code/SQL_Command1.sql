...
-- Submit Group Rating
INSERT INTO Feedback (NYU_Email, Meeting_ID, Rating, Comment)
VALUES (%(NYU_Email)s, %(Meeting_ID)s, %(Rating)s, %(Comment)s);

-- Upload File
INSERT INTO Study_Material (File_Name, File_Path, Meeting_ID)
VALUES (%(File_Name)s, %(File_Path)s, %(Meeting_ID)s);
...
f.Comment,
f.Rating
FROM Feedback f, Student s
WHERE f.NYU_Email = s.NYU_Email
AND f.Meeting_ID = %(Meeting_ID)s;
